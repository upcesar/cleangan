        ...
        private void SeedQuestionOptionsSelections(DAL.CleanGapDataContext context)
        {
            context.question_options
                   .AddOrUpdate(qo => qo.id,
                    ...
                    new question_options() { id = 173, id_question = 69, input_type = "checkbox", option_text = "Grid", order = 1 },
                    new question_options() { id = 174, id_question = 69, input_type = "checkbox", option_text = "Lines Quick Add", order = 2 },
                    new question_options() { id = 175, id_question = 69, input_type = "checkbox", option_text = "Lines Size Entry", order = 3 },

                    //Units to Display for Reps
                    new question_options() { id = 176, id_question = 70, input_type = "checkbox", option_text = "True inventory", order = 1 },
                    new question_options() { id = 177, id_question = 70, input_type = "checkbox", option_text = "Limited", order = 2 },
                    new question_options() { id = 178, id_question = 70, input_type = "checkbox", option_text = "Number to Limit at", order = 3 },

                    //Units to Display for Customer/B2B?
                    new question_options() { id = 179, id_question = 71, input_type = "checkbox", option_text = "True inventory", order = 1 },
                    new question_options() { id = 180, id_question = 71, input_type = "checkbox", option_text = "Limited", order = 2 },
                    new question_options() { id = 181, id_question = 71, input_type = "checkbox", option_text = "Number to Limit at", order = 3 },
