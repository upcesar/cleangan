        ...
        private void SeedQuestionOptionsLines(DAL.CleanGapDataContext context)
        {
            context.question_options
                   .AddOrUpdate(qo => qo.id,
                    ...
                    new question_options() { id = 240, id_question = 100, input_type = "radio", option_text = "Yes", order = 1 },
                    new question_options() { id = 241, id_question = 100, input_type = "radio", option_text = "No", order = 2 },

                    //Standard Additional Information: Show Gender
                    new question_options() { id = 242, id_question = 101, input_type = "radio", option_text = "Yes", order = 1 },
                    new question_options() { id = 243, id_question = 101, input_type = "radio", option_text = "No", order = 2 },

                    //Standard Additional Information: Show Dimensions
                    new question_options() { id = 244, id_question = 102, input_type = "radio", option_text = "Yes", order = 1 },
                    new question_options() { id = 245, id_question = 102, input_type = "radio", option_text = "No", order = 2 },

                    //Standard Additional Information: Show Product Group
                    new question_options() { id = 246, id_question = 103, input_type = "radio", option_text = "Yes", order = 1 },
                    new question_options() { id = 247, id_question = 103, input_type = "radio", option_text = "No", order = 2 },

                    //Standard Additional Information: Show Warehouse
                    new question_options() { id = 248, id_question = 104, input_type = "radio", option_text = "Yes", order = 1 },
                    new question_options() { id = 249, id_question = 104, input_type = "radio", option_text = "No", order = 2 },

                    //Standard Additional Information: Show Product Type?
                    new question_options() { id = 250, id_question = 105, input_type = "radio", option_text = "Yes", order = 1 },
                    new question_options() { id = 251, id_question = 105, input_type = "radio", option_text = "No", order = 2 }
